...
// 参考: https://github.com/Ma-Dan/YOLOv3-CoreML/blob/master/YOLOv3-CoreML/YOLOv3-CoreML/YOLO.swift
...
class YOLO {
  ...
  public func computeBoundingBoxes(features: [MLMultiArray]) -> [Prediction] {
    assert(features[0].count == 18*20*20)
    assert(features[1].count == 18*40*40)
    assert(features[2].count == 18*80*80)
    ...
    let gridHeight = [20, 40, 80]
    let gridWidth = [20, 40, 80]
